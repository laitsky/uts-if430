...
if (isset($_POST['text'])) {
    ...
    if ($text != "") {
        ...
        $time = time();
        query_my_sql("INSERT INTO messages VALUES(NULL, '$user','$view', '$pm', $time, '$text')");
    }
}
...
if (!$num)
    echo "<br><span>Tidak ada pesan</span><br>";

echo "<br><a href='messages.php?view=$view'>Segarkan pesan</a>";
